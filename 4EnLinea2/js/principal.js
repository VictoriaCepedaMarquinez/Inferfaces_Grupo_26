window.addEventListener('DOMContentLoaded', () => {
    ...
    function mostrarMenuInicio() {
        ...
        drawMenuInicio();
        let botones = [];
        let boton_fill = "#5b01c9";
        let boton_fill_clicked ="#5b01c9"; //#DD3333
        let boton_jugar;
        ...
        function dibujarTexto() {
            ...
            ctx.strokeText("Sims 4 vs Gta 5", canvas.width / 2, 50);
            ctx.fillText("Sims 4 vs Gta 5", canvas.width / 2, 50);
        ...
        function crearBotones() {
            ...
            boton_jugar =
                new Boton((canvas.width - (canvas.width / 4)) / 2, (posY - h_boton_t * 1.5) + 80, canvas.width / 4, h_boton_t + 10, "Jugar", "#fc03e5");
    ...
    function initGame(tablero, ficha_j1, ficha_j2) {
        ...
        fondo_gameover.src = "assets/juegoImages/simsgtafondo.png";
