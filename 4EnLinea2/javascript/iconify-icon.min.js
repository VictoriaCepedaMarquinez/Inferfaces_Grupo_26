...
!function() {
    ...
    function Ft(t, e) {
        ...
        if ("svg" === s)
            c = function(t) {
                ...
                return e.innerHTML = Ot(t.body, t.attributes),
                e.firstChild
            }(r);
        else
            c = function(t, e, n) {
                ...
                const r = t.attributes
                  , s = 'url("data:image/svg+xml,' + (u = Ot(i, {
                    ...r,
                    width: e.width + "",
                    height: e.height + ""
                }),
    ...
    function Pt(t, e) {
        ...
        t.appendChild(n)),
        n.textContent = ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block}"
    }
    function Rt(t, e, n) {
        return {
            rendered: !1,
